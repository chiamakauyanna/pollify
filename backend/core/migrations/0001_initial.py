# Generated by Django 5.2.5 on 2025-11-14 12:56
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('voter_id', models.CharField(blank=True, max_length=32, null=True, unique=True)),
                ('assigned_admin', models.ForeignKey(blank=True, limit_choices_to={'role': 'admin'}, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='voters', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('choice', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='votes', to='core.choice')),
            ...
            options={
                'constraints': [models.UniqueConstraint(fields=('poll', 'voter'), name='unique_vote_per_poll')],
            },
        ),
    ]
